      ...
      function customersReviews(){
           ...
           reviewList=[];
            ...
            // alert("form "+str);
             ...
             for(let i = 0; i<storedreview.length; i++){
              ...
              var accuReviews=message;
            for(let i = 0; i<reviewList.length; i++){
               let rev2=reviewList[i];
               if(rev2.id == id){
                 accuReviews= accuReviews+ rev2.review+"<br>";
               }
             }
        ...
        //=====================
          ...
          var mess = accuReviews.split("<br>");//reviews of current item
         ...
         document.getElementById("p-rate").innerHTML=custRate;
         document.getElementById("p-review").innerHTML=message;
         message="";
         accuReviews="";
      }
